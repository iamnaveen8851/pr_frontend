  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {/* Notification Badge */}
        {unreadCount > 0 && (
          <span className="absolute top-[7px] bottom-[15px] right-[7px] inline-flex items-center justify-center px-[7px] py-[5px] text-[10px] font-medium leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-500 rounded-full">
